...
| 05 | datasets: HTML + bundles → `mfb/{teams,rosters,schedules}/parquet/`, `mfb/datasets/{ay}/*.parquet` | `python/ncaa_mfb_05_datasets_build.py` | `scripts/run_05_datasets.sh` | **offline** (no proxy) | pure function of the tree; re-run overwrites; NOT sharded (one file per kind) | `./scripts/run_05_datasets.sh --academic-year 2026` |
